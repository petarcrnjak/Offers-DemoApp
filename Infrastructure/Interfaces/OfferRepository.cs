...
public class OfferRepository : IOfferRepository
{
    ...
    {
        //var totalCount = await _context.Offers.CountAsync();
        return await _context.Offers
            .OrderBy(o => o.Id)
    ...
    {
        return await _context.OfferItems.FirstOrDefaultAsync(o => o.Id == id);
    }
    ...
    public async Task<bool> DeleteOfferItemAsync(int offerId, int itemId)
    {
        ...
        //var itemToRemove = offer.OfferItems.FirstOrDefault(i => i.Id == itemId);
        var itemToRemove = offer.OfferDetails.FirstOrDefault(x => x.OfferId == offerId && x.OfferItemId == itemId);
        if (itemToRemove == null) return false;

        //offer.OfferItems.Remove(itemToRemove);
    ...
    {
        return await _context.OfferItems.OrderBy(x => x.Article).ToListAsync();
    }
